...
{
    CIniHelper ini_helper(m_ini_path);
    SkinData data;
    if (m_ini_path.empty())
        return data;
...
bool CSkinEditorHelper::SaveSkin(const SkinData& data, bool asign_item_text, bool assign_font)
{
    ...
    ini_helper.WriteIntArray(L"skin", L"text_color", (int*)data.text_colors, MAIN_WND_COLOR_NUM);
    ini_helper.WriteBool(L"skin", L"specify_each_item_color", data.specify_each_item_color);
    ...
    if (assign_font)
    {
        //ini_helper.WriteString(L"skin", L"font_name", data.font_name);
        //ini_helper.WriteInt(L"skin", L"font_size", data.font_size);
        ini_helper.SaveFontData(L"skin", data.font);
    }
    ...
    ini_helper.WriteInt(L"layout", L"up_align_l", static_cast<int>(data.up_align_l));
    ...
    ini_helper.WriteInt(L"layout", L"down_align_l", static_cast<int>(data.down_align_l));
    ...
    ini_helper.WriteInt(L"layout", L"cpu_align_l", static_cast<int>(data.cpu_align_l));
    ...
    ini_helper.WriteInt(L"layout", L"memory_align_l", static_cast<int>(data.memory_align_l));
    ...
    ini_helper.WriteInt(L"layout", L"up_align_s", static_cast<int>(data.up_align_s));
    ...
    ini_helper.WriteInt(L"layout", L"down_align_s", static_cast<int>(data.down_align_s));
    ...
    ini_helper.WriteInt(L"layout", L"cpu_align_s", static_cast<int>(data.cpu_align_s));
    ...
    ini_helper.WriteInt(L"layout", L"memory_align_s", static_cast<int>(data.memory_align_s));
