...
void CScintillaEditView::SetFontFace(const wchar_t* font_face)
{
    ...
    std::string str_font_face = CCommon::UnicodeToStr(font_face, char_connot_convert, CodeType::UTF8_NO_BOM);
...
void CScintillaEditView::SetSel(int start, int end, const std::wstring& edit_str)
{
...
CScintillaEditView::eEolMode CScintillaEditView::JudgeEolMode(const std::wstring& str)
{
...
void CScintillaEditView::SetLexerXml()
{
    ...
    SetSyntaxColor(SCE_H_ATTRIBUTEUNKNOWN, 0x7474A4);
    SetSyntaxColor(SCE_H_NUMBER, 0x225AD6);
    SetSyntaxColor(SCE_H_DOUBLESTRING, 0xBA265E);
    SetSyntaxColor(SCE_H_SINGLESTRING, 0xBA265E);
    SetSyntaxColor(SCE_H_OTHER, 0x2E2E2E);
    SetSyntaxColor(SCE_H_COMMENT, 0xB840B);
    SetSyntaxColor(SCE_H_ENTITY, 0x2E2E2E);
    SetSyntaxColor(SCE_H_TAGEND, 0xDD5A19);
    SetSyntaxColor(SCE_H_XMLSTART, 0x8132B1);
    SetSyntaxColor(SCE_H_XMLEND, 0x8132B1);
    SetSyntaxColor(SCE_H_SCRIPT, 0x506E6C);
